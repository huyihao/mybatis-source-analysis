...
public class MapperBuilderAssistant extends BaseBuilder {
	 ...
	 private String currentNamespace;     //  mapper.xml文件中<mapper>节点的namespace属性，为Mapper接口的含包名类名，eg: <mapper namespace="com.learn.ssm.chapter5.mapperInterface.RoleMapper"></mapper>
	 ...
	 public Discriminator buildDiscriminator(Class<?> resultType,
		 ...
		 ResultMapping resultMapping = buildResultMapping(resultType,
				 										  null, 
				 										  column, 
				 										  javaType, 
				 										  jdbcType, 
